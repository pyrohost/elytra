...
type Client interface {
	...
	GetServerRusticConfig(ctx context.Context, serverUuid string, backupType string) (RusticBackupRequest, error)
...
func (c *client) requestOnce(ctx context.Context, method, path string, body io.Reader, opts ...func(r *http.Request)) (*Response, error) {
	...
	req.Header.Set("User-Agent", fmt.Sprintf("Elytra/v%s (id:%s)", system.Version, c.tokenId))
