...
// LocalBackup is deprecated. Use RusticLocalBackup instead for better performance,
// encryption, and deduplication features.
//
// Deprecated: This backup method will be removed in a future version.
// Please migrate to rustic-powered backups.
