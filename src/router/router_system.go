...
// Returns information about the system that elytra is running on.
...
// Creates a new server on the elytra daemon and begins the installation process
// for it.
...
// Updates the running configuration for this Elytra instance.
