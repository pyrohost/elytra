...
func RequireAuthorization() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// All requests to Elytra must be authorized with the authentication token present in
		// the Elytra configuration file. Remeber, all requests to Elytra come from the Panel
